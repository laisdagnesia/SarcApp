...
export function DiagnosticoScreen () {
    ...
    {/**Próxima tela Diagnóstico: 
       -  Paciente não sarcopênico (nenhuma avaliação positiva)
       - Paciente com sarcopenia provável (apenas baixa força muscular)
        Paciente sarcopênico (baixa força +baixa massa muscular)
        -Paciente sarcopênico grave (baixa força + baixa massa + baixo desempenho físico)
    ...
    return (
      ...
      >
        ...
        raised={true}></Button>
         ...
         containerStyle={{borderRadius: 80,width: 320, marginLeft:30, marginTop:90}} 
         buttonStyle={{ backgroundColor: 'blue',borderRadius: 80}}
        raised={true}></Button>
         </ImageBackground>
         </ScrollView>
